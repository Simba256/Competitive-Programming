...
void solve(){
    ...
    if(f>1) cout<<"NO SOLUTION";
        ...
        if(f){
            for(int i=0;i<26;i++){
                if(i==a) continue;
                for(int j=0;2*j<v[i];j++) cout<<char(i+'A');
            }for(int i=0;i<v[a];i++) cout<<char(int(a)+'A');       
            for(int i=25;i>=0;i--){
                if(i==a) continue;
                for(int j=0;2*j<v[i];j++) cout<<char(i+'A');
            } 
            ...
            for(int i=0;i<26;i++) for(int j=0;2*j<v[i];j++) cout<<char(i+'A');
            for(int i=25;i>=0;i--) for(int j=0;2*j<v[i];j++) cout<<char(i+'A');
        }
    }
