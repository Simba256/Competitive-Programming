    ...
    void solve(){
        ...
        // cout<<"a:";for(auto x:a) cout<<x<<" ";nl;
        // cout<<"b:";for(auto x:b) cout<<x<<" ";nl;
        ...
        ans = max(max(ans,ans1),max(ans2,ans3));
        so(a);
        sod(b);
        ans1 = 0;
        rep(0,n/2,i) ans1 += abs(a[i]-b[i]);
        sod(a);
        so(b);
        rep(0,n-n/2,i) ans1 += abs(a[i]-b[i]);

        ans2 = 0;
        sod(a);
        so(b);
        ans1 = 0;
        rep(0,n/2,i) ans2 += abs(a[i]-b[i]);
        so(a);
        sod(b);
        rep(0,n-n/2,i) ans2 += abs(a[i]-b[i]);
